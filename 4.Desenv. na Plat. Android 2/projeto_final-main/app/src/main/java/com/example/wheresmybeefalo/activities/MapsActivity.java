...
import com.example.wheresmybeefalo.databinding.ActivityMapsBinding;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        voltar = findViewById(R.id.btnBack);
    ...
    public void onMapReady(@NonNull GoogleMap googleMap) {
        ...
        String endereco = intent.getStringExtra("enderecoSelecionado").toString();
        LatLng localizacao = determineLatLngFromAddress(getApplicationContext(), endereco);
        if(localizacao == null){
            Toast.makeText(this, "falha ao acessar localização", Toast.LENGTH_SHORT).show();
        }else {
